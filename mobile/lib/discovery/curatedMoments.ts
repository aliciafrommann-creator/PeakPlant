...
export const CURATED_MOMENTS: TogetherMoment[] = [
  ...
  m('cm-s22', 'a day with the phone in a drawer', 'one waking day, out of reach, not on silent. notice what the hands do instead.', 'calm', { indoorOutdoor: 'flexible', idealTimeOfDay: ['morning', 'afternoon', 'evening'], priceBand: 'free', avgDurationMin: 240, energy: 'low', weatherFit: ['any'], spaceTypes: SOLO }),
  ...
  m('cm-s29', 'say yes to the first invitation', 'whatever lands in the next week — go, even if the evening was already spoken for.', 'play', { indoorOutdoor: 'flexible', idealTimeOfDay: ['evening'], priceBand: '€', avgDurationMin: 120, weatherFit: ['any'], spaceTypes: SOLO }),
