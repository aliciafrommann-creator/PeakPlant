...
const styles = StyleSheet.create({
  ...
  skip: { fontSize: 12, fontWeight: '400', letterSpacing: 1.2, color: Colors.textSubtle },
  headerTitle: { fontSize: 12, fontWeight: '500', letterSpacing: 1.2, color: Colors.text },
  saveBtn: { fontSize: 12, fontWeight: '500', letterSpacing: 1.2, color: Colors.text },
  ...
  charCount: { fontSize: 12, fontWeight: '300', color: Colors.textSubtle, alignSelf: 'flex-end' },
  publicShareBlock: {
    gap: Spacing.sm,
    padding: Spacing.md,
  ...
  publicShareText: { fontSize: 11, fontWeight: '500', letterSpacing: 1.2, color: Colors.textMuted },
