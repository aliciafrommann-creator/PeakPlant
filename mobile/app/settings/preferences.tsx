          ...
          <View style={styles.learnToggleLeft}>
            ...
            <Text style={styles.signalNote}>
              {t(
                ...
                'hebt sanft Ideen hervor, die du merkst, planst und abschließt. nur deine eigenen Aktionen - nie abgeleitet.',
              )}
            </Text>
          </View>
          <Switch
            ...
            <>
              {learning.liked.length > 0 && (
                <View style={styles.learnedBlock}>
                  <Text style={styles.learnedHeading}>{t('you seem drawn to', 'du scheinst dich hingezogen zu fühlen zu')}</Text>
...
const styles = StyleSheet.create({
  ...
  emptyHint: { fontSize: 13, fontWeight: '300', color: Colors.textSubtle, lineHeight: 19 },
  signalRow: {
    flexDirection: 'row',
  ...
  signalNote: { fontSize: 11, fontWeight: '300', color: Colors.textSubtle, lineHeight: 16 },
  ...
  neverBullet: { fontSize: 13, fontWeight: '300', color: Colors.textSubtle, marginTop: 1 },
  ...
  clearText: { fontSize: 12, fontWeight: '500', letterSpacing: 1.2, color: Colors.danger },
  learnToggleRow: {
    flexDirection: 'row',
    alignItems: 'center',
    justifyContent: 'space-between',
  ...
  learnedFrom: { fontSize: 12, fontWeight: '300', color: Colors.textSubtle, letterSpacing: 0.3 },
  footer: {
    fontSize: 11,
    fontWeight: '300',
    color: Colors.textSubtle,
